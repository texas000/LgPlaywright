...
================================================================================
📦 Add to Cart API Response Summary
================================================================================
...
────────────────────────────────────────────────────────────────────────────────
{
  "cartInfo": {
    "cartId": 333325,
    "publicCartId": "8B234A952078D49CFEAD0B5160D",
    "storeCode": "OBS",
    "isGuest": true,
    "itemCount": 1,
    "totalItemQty": 1
  ...
  "items": [
    {
      "cartItemId": 927631,
      "sku": "MD09033846.OBS",
      "name": "77 Inch Class LG OLED evo AI G5 4K Smart TV 2025",
      "qty": 1,
      "pricing": {
        "listPrice": 4499.99,
        "price": 3499.99,
      ...
      "attributes": {
        "sku": "OLED77G5WUA",
        "pdpUrl": "/us/tvs/lg-oled77g5wua-oled-4k-tv",
...
- ✅ JSON 응답 구조 검증
- ✅ **테이블 형식 응답 출력** (가독성 향상)
  - Cart 기본 정보 (ID, Item Count, Total Quantity)
  - Cart Items 상세 정보 (Model Name, Price, Quantity 등)
  - API Response Status
  - **선택적 주요 데이터** (중요 정보만 필터링)
    - Cart Info: cartId, publicCartId, storeCode, itemCount 등
    - Pricing: listPrice, subtotal, discount, tax, shipping, grandTotal
    - Items: SKU, name, pricing, inventory, fulfillment info
